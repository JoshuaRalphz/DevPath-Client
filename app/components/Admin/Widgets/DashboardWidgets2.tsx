...
const DashboardWidgets: FC<Props> = ({ open }) => {
  ...
  return (
    <div className="mt-[30px] min-h-screen">
      {/* Responsive grid for Course Analytics and Sales Data */}
      ...
      {/* Responsive grid for Orders Analytics and Recent Transactions */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
        {/* Orders Analytics */}
        <div className="dark:bg-[#111c43] w-full h-[40vh] shadow-sm p-4">
