...
const AdminSidebar = () => {
  ...
  const arrowIconColor = theme === "dark" ? "#ffffffc1" : "#000";
    ...
    >
      <Sidebar
        ...
        style={{
          ...
          backgroundColor: theme === "dark" ? "#111C43" : "#ffffff", // solid background color
        }}
      >
        <Menu>
          {/* LOGO AND MENU ICON */}
          <MenuItem
            ...
            icon={isCollapsed ? <ArrowForwardIosIcon style={{ color: arrowIconColor }} /> : undefined}
            style={{
          ...
          >
            {!isCollapsed && (
              ...
              >
                ...
                >
                  <ArrowBackIosIcon style={{ color: arrowIconColor }} />
                </IconButton>
              </Box>
            )}
          </MenuItem>
