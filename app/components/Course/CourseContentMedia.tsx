...
const CourseContentMedia = ({
  ...
  return (
    <div className="w-[95%] 800px:w-[86%] py-4 m-auto">
      ...
      <br />
      {activeBar === 0 && (
        <p className="text-[18px] whitespace-pre-line mb-3 dark:text-white text-black mt-5">
                ...
                (item: any, index: number) => {
                  ...
                  return (
                    <div className="w-full my-5 dark:text-white text-black" key={index}>
                      ...
                      {user.role === "admin" || "instructor" && item.commentReplies.length === 0 && (
                        <span
                        ...
                        <div className="w-full flex 800px:ml-16 my-5" key={index}>
                          ...
                          <div className="pl-2">
                            <div className="flex items-center">
                              ...
                              {i.user.role === "instructor" && (
                                <VscVerifiedFilled className="text-[#FFD700] ml-2 text-[20px]" />
                              )}
                            </div>
                            <p>{i.comment}</p>
                ...
                <div className="pl-3">
                  <div className="flex items-center">
                    ...
                    {item.user.role === "instructor" && (
                      <BiBadgeCheck className="text-[#FF0000] ml-2 text-[20px]"/>
                    )}
                  </div>
                  <p>{item.answer}</p>
                  <small className="text-[#ffffff83]">
